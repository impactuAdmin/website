                    ...
                    <div className="container-contactos reveal">
                        ...
                        <div className="container">
                            <form name="contactos" method="POST" data-netlify="true" action="/Sucesso">
                                ...
                                <label htmlFor="nameInput">Nome<span className="asterisk"> *</span></label>
                                <input type="text" id="nameInput" name="nome" placeholder="Nome" required />
                                <label htmlFor="emailInput">Email<span className="asterisk"> *</span></label>
                                <input type="email" id="emailInput" name="email" placeholder="Email" required />
                                <label htmlFor="subject">Assunto/Mensagem<span className="asterisk"> *</span></label>
                                    ...
                                    <div className='link-underline contactos intro'>
                                        <a>
                                            ...
                                            <svg className='arrow' xmlns="http://www.w3.org/2000/svg" width="19" height="14" viewBox="0 0 19 14">
                                                <path d="M17.6151 7.0705H0.515381V7.99454H17.6151V7.0705Z" strokeWidth="1"
                                                    strokeMiterlimit="102" />
                                                <path d="M18.5153 7.30319L12.1274 1L11.5484 1.57138L17.9363 7.87457L18.5153 7.30319Z" strokeWidth="1" strokeMiterlimit="10" />
                                                <path d="M17.3516 7.30151L11.5464 13.0297L12.1254 13.6011L17.9306 7.8729L17.3516 7.30151Z" strokeWidth="1" strokeMiterlimit="10" />
                                            </svg>
                                        </a>
                                    </div>
                                 </div>
