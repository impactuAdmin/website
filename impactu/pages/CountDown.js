...
const CountDown = () => {
    ...
    const [absoluteTimeLeft, setAbsoluteTimeLeft] = useState(calculateTimeLeft());

	useEffect(() => {
        const difference = premierDate - +new Date();
        setAbsoluteTimeLeft(difference)

        console.log(absoluteTimeLeft);

        if(absoluteTimeLeft <= 1000) {
            Router.push("/")
        }
    ...
    if(absoluteTimeLeft <= 60 * 1000 && absoluteTimeLeft >= 0) { //ultimo minuto
        return (
            <>
                    <section className='qrcode'>
                        <h2>
                            <img src="/qrCode.png" alt="qrCode" style={{width: "50%"}}/>
                        </h2>
                    </section>
            </>
        )
        ...
        return (
            < >
                      <section className='countdown'>
                          <h2>
                              <a className='logo-container-countdown' >
                                  <svg className='logo-countdown' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 686 161" fill="none">
                                      <path d="M31.6571 25.8997H0.748047V122.235H31.6571V25.8997Z" fill="#10845a" />
