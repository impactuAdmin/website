...
const ImpactoSocial = () => {
  return (
    <>
      ...
      <section id="social" className={styles['impactosocial-background']}>
        <section className={`${styles['impactosocial-intro-content']} reveal`}>
          <div className={styles['impactosocial-intro-title']}>
            <h1>O nosso impacto:</h1>
            <h2>Social</h2>
          </div>
          <div className={styles['impactosocial-intro-title-2']}>
            <div className={styles['impactosocial-intro-img']}>
              <img src="/senhora.webp" alt="senhora" />
            </div>

            <div className={styles['impactosocial-intro-text']}>
              <h3>
